    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          <img src={Image1} alt="image" className="pricing__img" />
          ...
          <a href="mailto:saranshchaurasia9@gmail.com?subject=Basic Membership" className="btn">
            Get Started
          </a>
        </div>
        ...
        <span className="badge">Recommended</span>
          <img src={Image2} alt="image" className="pricing__img" />
          ...
          <a href="mailto:saranshchaurasia9@gmail.com?subject=Premium Membership" className="btn">
            Get Started
          </a>
        </div>

        <div className="pricing__item">
          <img src={Image3} alt="image" className="pricing__img" />
          ...
          <a href="mailto:saranshchaurasia9@gmail.com?subject=Ultimate Membership" className="btn">
            Get Started
          </a>
        </div>
      </div>
